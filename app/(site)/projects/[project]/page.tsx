...
const MyProject = async ({ params }: Props) => {
	...
	return <div>
		...
		{project.image && <Image src={project.image} alt={project.name} width={1920} height={1080} className="mt-10 border-2 border-gray-700 object-cover rounded-lg" />}
	</div>;
};
